...
dataset = [
    ...
    (["explain cataracts","explanation cataracts", "what is cataracts", "cataracts explanation"], "A clouding of the normally clear lens of the eye, leading to a decrease in vision.", None,["z-img/common/cataracts.png"]),
    (["explain chickenpox","explanation chickenpox", "what is chickenpox", "chickenpox explanation"], "A highly contagious viral infection causing an itchy, blister-like rash on the skin.",None,["z-img/common/chickenpox.png"]),
    ...
    (["explain albinism", "what is albinism", "albinism explanation"], "A genetic condition characterized by a lack of melanin pigment in the skin, hair, and eyes, leading to very light skin and vision problems.", None,["z-img/common/chickenpox.png"]),
    ...
    (["explain Asperger's syndrome", "what is Asperger's syndrome", "Asperger's syndrome explanation"], "A developmental disorder on the autism spectrum, characterized by difficulties in social interaction and nonverbal communication, along with restricted and repetitive patterns of behavior and interests.", None,[]),
    ...
    (["explain avian influenza", "what is avian influenza", "avian influenza explanation"], "Also known as bird flu, it is a viral infection spread from birds to humans, causing flu-like symptoms and potentially severe respiratory issues.",None,["z-img/common/influenza.png"]),
    (["explain Behçet's disease", "what is Behçet's disease", "Behçet's disease explanation"], "A rare disorder causing blood vessel inflammation throughout the body, leading to mouth sores, eye inflammation, skin rashes, and genital sores.", None,[]),
    ...
    (["explain Charcot-Marie-Tooth disease", "what is Charcot-Marie-Tooth disease", "Charcot-Marie-Tooth disease explanation"], "A group of inherited disorders that cause nerve damage, leading to muscle weakness and loss of sensation in the limbs.", None,[]),
    (["explain chronic obstructive pulmonary disease", "what is chronic obstructive pulmonary disease", "chronic obstructive pulmonary disease explanation"], "A chronic inflammatory lung disease causing obstructed airflow from the lungs, leading to breathing difficulties.", None,[]),
    (["explain Creutzfeldt-Jakob disease", "what is Creutzfeldt-Jakob disease", "Creutzfeldt-Jakob disease explanation"], "A rare, degenerative, fatal brain disorder characterized by rapid neurodegeneration, leading to dementia and death.", None,[]),
    (["explain Dandy-Walker syndrome", "what is Dandy-Walker syndrome", "Dandy-Walker syndrome explanation"], "A congenital brain malformation involving the cerebellum and the fluid-filled spaces around it, leading to problems with movement and coordination.", None,[]),
    ...
    (["explain Fabry disease", "what is Fabry disease", "Fabry disease explanation"], "A rare genetic disorder that affects lipid metabolism, leading to pain, kidney failure, heart problems, and other complications.", None,[]),
    (["explain hemophilia", "what is hemophilia", "hemophilia explanation"], "A genetic disorder where blood doesn't clot normally due to lack of sufficient blood-clotting proteins, leading to prolonged bleeding.", None,[]),
    (["explain idiopathic pulmonary fibrosis", "what is idiopathic pulmonary fibrosis", "idiopathic pulmonary fibrosis explanation"], "A chronic, progressive lung disease where the tissue in the lungs becomes thick and stiff, leading to breathing difficulties.", None,[]),
    (["explain Kawasaki disease", "what is Kawasaki disease", "Kawasaki disease explanation"], "A condition in children that involves inflammation of the blood vessels, leading to fever, rash, and swelling of the hands and feet.", None,[]),
    (["explain moyamoya disease", "what is moyamoya disease", "moyamoya disease explanation"], "A rare, progressive cerebrovascular disorder caused by blocked arteries at the base of the brain, leading to strokes and other neurological issues.", None,[]),
    ...
    (["explain chronic obstructive pulmonary disease","explanation chronic obstructive pulmonary disease", "what is chronic obstructive pulmonary disease", "chronic obstructive pulmonary disease explanation"], "A group of lung diseases that block airflow and make it difficult to breathe.", None,[]),
    ...
    (["explain Crohn's disease","explanation Crohn's disease", "what is Crohn's disease", "Crohn's disease explanation"], "A chronic inflammatory bowel disease affecting the lining of the digestive tract.", None,[]),
    ...
    (["explain Down syndrome","explanation Down syndrome", "what is Down syndrome", "Down syndrome explanation"], "A genetic chromosome 21 disorder causing developmental and intellectual delays.", None,[]),
    ...
    (["explain eczema","explanation eczema", "what is eczema", "eczema explanation"], "A condition that makes the skin red, itchy, and inflamed.", None,["z-img/common/eczema.png"]),
    ...
    (["explain high blood pressure","explanation high blood pressure", "what is high blood pressure", "high blood pressure explanation"], "A condition in which the force of the blood against the artery walls is too high.", None,[]),
    (["explain AIDS","explanation AIDS", "what is AIDS", "AIDS explanation", "AIDS"], "A virus that attacks the body's immune system and can lead to AIDS if not treated.", None,[]),
    (["explain Huntington's disease","explanation Huntington's disease", "what is Huntington's disease", "Huntington's disease explanation"], "A genetic disorder causing the progressive breakdown of nerve cells in the brain, leading to physical and mental decline.", None,[]),
    ...
    (["explain acne","explain what acne", "what is acne", "explanation acne", "acne explanation"], "A skin condition characterized by red pimples, blackheads, and whiteheads caused by clogged hair follicles.",None,["z-img/common/acne.png"]),
    (["explain allergies","explanation allergies", "what is allergies", "allergies explanation"], "Immune system reactions to foreign substances like pollen, pet dander, or certain foods, causing symptoms like sneezing, itching, and swelling.",None,["z-img/common/allergies.png"]),
    (["explain Alzheimer's disease","explanation alzheimer's disease", "what is alzheimer's disease", "alzheimer's explanation"], "A progressive neurological disorder leading to memory loss, cognitive decline, and personality changes.", None,[]),
    ...
    (["explain arthritis","explanation arthritis", "what is arthritis", "arthritis explanation"], "Inflammation of one or more joints, causing pain and stiffness that can worsen with age.",None,["z-img/common/arthritis.png"]),
    ...
    (["explain bronchitis","explanation bronchitis", "what is bronchitis", "bronchitis explanation"], "Inflammation of the lining of bronchial tubes, which carry air to and from the lungs, causing coughing and difficulty breathing.", None,[]),
    ...
    (["explain irritable bowel syndrome","explanation irritable bowel syndrome", "what is irritable bowel syndrome", "irritable bowel syndrome explanation"], "A gastrointestinal disorder causing abdominal pain, bloating, and changes in bowel habits.", None,[]),
    ...
    (["explain sickle cell disease", "what is sickle cell disease", "sickle cell disease explanation"], "A group of inherited red blood cell disorders characterized by abnormal hemoglobin, leading to distorted (sickle-shaped) red blood cells.", None,[]),
    (["explain Sjögren's syndrome", "what is Sjögren's syndrome", "Sjögren's syndrome explanation"], "An autoimmune disease characterized by dry eyes and dry mouth, often accompanied by other immune system disorders.", None,[]),
    ...
    (["explain Stevens-Johnson syndrome", "what is Stevens-Johnson syndrome", "Stevens-Johnson syndrome explanation"], "A rare, serious disorder of the skin and mucous membranes, usually a reaction to a medication or infection, causing blisters and peeling skin.", None,[]),
    (["explain Tay-Sachs disease", "what is Tay-Sachs disease", "Tay-Sachs disease explanation"], "A rare, inherited disorder that destroys nerve cells in the brain and spinal cord, leading to severe neurological impairment and early death.", None,[]),
    (["explain toxic shock syndrome", "what is toxic shock syndrome", "toxic shock syndrome explanation"], "A rare, life-threatening complication of certain bacterial infections, often associated with tampon use, causing high fever, low blood pressure, and organ damage.", None,[]),
    (["explain Tourette syndrome", "what is Tourette syndrome", "Tourette syndrome explanation"], "A neurological disorder characterized by repetitive, involuntary movements and vocalizations called tics.", None,[]),
    ...
    (["explain trichinosis", "what is trichinosis", "trichinosis explanation"], "A parasitic disease caused by roundworms, typically acquired by eating undercooked meat containing the larvae of the parasite, leading to digestive and muscle symptoms.", None,[]),
    ...
    (["explain vitiligo", "what is vitiligo", "vitiligo explanation"], "A condition where the skin loses its pigment cells (melanocytes), resulting in discolored patches in different areas of the body.",None,["z-img/common/vitiligo.png"]),
    (["explain Wilson's disease", "what is Wilson's disease", "Wilson's disease explanation"], "A rare genetic disorder causing excessive copper accumulation in the liver, brain, and other vital organs, leading to neurological and psychiatric symptoms.", None,[]),
    (["explain Parkinson's disease","explanation Parkinson's disease", "what is Parkinson's disease", "Parkinson's disease explanation"], "A progressive nervous system disorder affecting movement, causing tremors, stiffness, and slow movement.", None, []),
    ...
    (["explain psoriasis","explanation psoriasis", "what is psoriasis", "psoriasis explanation"], "An autoimmune condition that causes the rapid buildup of skin cells, leading to scaling on the skin's surface.", None,["z-img/common/psoriasis.png"]),
    (["explain POTS syndrome", "what is POTS syndrome", "POTS syndrome explanation"], "A condition affecting blood flow, leading to lightheadedness, fainting, and rapid heartbeat when standing up.", None,[]),
    (["explain prion disease", "what is prion disease", "prion disease explanation"], "A group of rare, fatal brain disorders caused by misfolded proteins, leading to rapid neurodegeneration.", None,[]),
    (["explain Raynaud's disease", "what is Raynaud's disease", "Raynaud's disease explanation"], "A condition where smaller arteries that supply blood to the skin constrict excessively in response to cold or stress, leading to numbness and color changes in fingers and toes.", None,[]),
    ...
    (["explain Reye's syndrome", "what is Reye's syndrome", "Reye's syndrome explanation"], "A rare but serious condition causing swelling in the liver and brain, often associated with the use of aspirin in children recovering from a viral infection.", None,[]),
    ...
    (["explain scurvy", "what is scurvy", "scurvy explanation"], "A condition caused by a severe lack of vitamin C, leading to anemia, weakness, gum disease, and skin problems.", None, ["z-img/common/scurvy.png"]),
    ...
    (["explain rabies","explanation rabies", "what is rabies", "rabies explanation"], "A viral disease causing inflammation of the brain in humans and other mammals, transmitted through the bite or scratch of an infected animal.", None,["z-img/common/rabies.png"]),
    ...
    (["explain schizophrenia","explanation schizophrenia", "what is schizophrenia", "schizophrenia explanation"], "A serious mental disorder in which people interpret reality abnormally, leading to hallucinations, delusions, and extremely disordered thinking and behavior.", None,[]),
    (["explain shingles","explanation shingles", "what is shingles", "shingles explanation"], "A viral infection causing a painful rash, usually appearing as a single stripe of blisters wrapping around either the left or the right side of the torso.", None,[]),
    ...
    (["explain syphilis","explanation syphilis", "what is syphilis", "syphilis explanation"], "A sexually transmitted infection caused by the bacterium Treponema pallidum, leading to long-term complications if not treated properly.", None,[]),
    ...
    (["explain Addison's disease", "what is Addison's disease", "Addison's disease explanation"], "A disorder in which the adrenal glands don't produce enough hormones, causing fatigue, muscle weakness, and weight loss.", None,[]),
    (["explain amyotrophic lateral sclerosis", "what is amyotrophic lateral sclerosis", "amyotrophic lateral sclerosis explanation"], "A progressive neurodegenerative disease affecting nerve cells in the brain and spinal cord, leading to muscle weakness and paralysis.", None,[]),
    ...
    (["explain black lung disease", "what is black lung disease", "black lung disease explanation"], "A lung disease caused by long-term inhalation of coal dust, leading to lung damage and respiratory issues.", None,[]),
    ...
    (["explain cat scratch disease", "what is cat scratch disease", "cat scratch disease explanation"], "An infection caused by a bacteria transmitted by a cat scratch or bite, leading to swollen lymph nodes and fever.", None,["z-img/common/catscratch.png"]),
    (["explain chagas disease", "what is chagas disease", "chagas disease explanation"], "A tropical parasitic disease transmitted by insects, causing acute symptoms and chronic complications affecting the heart and digestive system.", None,[]),
    (["explain chronic fatigue syndrome", "what is chronic fatigue syndrome", "chronic fatigue syndrome explanation"], "A complex disorder characterized by extreme fatigue that can't be explained by any underlying medical condition.", None,[]),
    (["explain Cushing's syndrome", "what is Cushing's syndrome", "Cushing's syndrome explanation"], "A condition caused by prolonged exposure to high levels of cortisol, leading to weight gain, high blood pressure, and skin changes.", None,[]),
    (["explain dengue fever", "what is dengue fever", "dengue fever explanation"], "A mosquito-borne viral infection causing flu-like symptoms, severe joint and muscle pain, and rash.", None,["z-img/common/dengue.png"]),
    ...
    (["explain Guillain-Barre syndrome", "what is Guillain-Barre syndrome", "Guillain-Barre syndrome explanation"], "A rare neurological disorder where the body's immune system mistakenly attacks the peripheral nerves, leading to muscle weakness and paralysis.", None,[]),
    (["explain histoplasmosis", "what is histoplasmosis", "histoplasmosis explanation"], "A fungal infection caused by inhaling spores, often from bird or bat droppings, leading to respiratory symptoms.", None,[]),
    (["explain Huntington's disease", "what is Huntington's disease", "Huntington's disease explanation"], "A genetic disorder causing the progressive breakdown of nerve cells in the brain, affecting movement, cognition, and behavior.", None,[]),
    (["explain Legionnaires' disease", "what is Legionnaires' disease", "Legionnaires' disease explanation"], "A severe form of pneumonia caused by the Legionella bacteria, leading to lung inflammation and respiratory issues.", None,[]),
    (["explain Lou Gehrig's disease", "what is Lou Gehrig's disease", "Lou Gehrig's disease explanation"], "Also known as ALS, a progressive neurodegenerative disease affecting nerve cells in the brain and spinal cord, leading to muscle weakness and paralysis.", None,[]),
